          ...
          <div class="row g-0">
            <div class="col-xl-2  d-xl-block">
              ...
              <div class="hero">
                <div class="card card1">
                  ...
                  <label for="input-file" class="label1">Upload profile</label>
            ...
            <div class="col-xl-9">
              ...
              <div class="card-body p-md-5 text-black">
                ...
                <h3 class="mb-5 text-uppercase" style="color: #ff9a03;"> Registration form</h3>
                <p style="text-align:justify">मी बृहन्मुंबई महानगरपालिकेत कार्यरत /सेवानिवृत्त कर्मचारी आहे. मराठा मंडळ सामाजिक संस्थेचे उद्देश, कार्य आणि नियम यांची
                  संपूर्ण माहिती मला आहे व ते मला मान्य आहे. सर्व नियमांचे तंतोतंत पालन मी करेन. संस्थेचा आजीवन/ वार्षिक सभासद होण्याची माझी इच्छा
                  आहे व त्यासाठी असणारे आजीवन सभासद शुल्क/वार्षिक सभासद शुल्क भरण्यास मी तयार आहे.</p>
                <p><b>(आजीवन सभासद शुल्क- रुपये १००१/-, वार्षिक सभासद शुल्क- रुपये २०१/-, प्रवेश फी- रुपये ५१/-)</b></p>
                <p><b>शुल्क भरल्याचा तपशील :-</b></p>

                <div class="form-outline mb-4">
                  <input type="text" id="form3Example97" class="form-control form-control-lg" />
                  <label class="form-label" for="form3Example97">Cheque/Netbanking/GPay/PhonePay/PayTM <span style="font-size:12px">(Netbanking ने भरले असल्यास बँकेचे नाव द्यावे)</span>
                  </label>
                ...
                <div class="row">
                  <div class="col-md-6 mb-4">
                    <div class="form-outline">
                      <input type="text" id="form3Example1m1" class="form-control form-control-lg" name="recommender_name" />
                      <label class="form-label" for="form3Example1m1">Name of Recommender/शिफारस करणाऱ्याचे नाव:-</label>
                    </div>
                  </div>
                  <div class="col-md-6 mb-4">
                    <div class="form-outline">
                      <input type="text" id="form3Example1n1" class="form-control form-control-lg"name="recommender_mobile_no" />
                      <label class="form-label" for="form3Example1n1"> Mobile No/मोबाईल नंबर</label>
                    </div>
                  </div>
                  <div class="col-md-6 mb-4">
                    <div class="form-outline">
                      <input type="text" id="form3Example1n1" class="form-control form-control-lg"name="recommendation_date" />
                      <label class="form-label" for="form3Example1n1"> Date/</label>
                    </div>
                  </div>
                  <div class="col-md-6 mb-4">
                    <div class="form-outline">
                      <input type="text" id="form3Example1n1" class="form-control form-control-lg" name="recommender_member_no" />
                      <label class="form-label" for="form3Example1n1"> Member No/सभासद क्र.</label>
                    </div>
                  </div>

                  <p>मी वरील अर्जदार यांना ओळखतो/ओळखते . ते मराठा/कुणबी/कुणबी मराठा आहेत. संस्थेच्या सभासद होण्यासाठी मी त्यांची शिफारस करतो/करते. </p>
...
<script>
  let signpic = document.getElementById("sign-pic");
  let inputFiles = document.getElementById("input-files");


  inputFiles.onchange = function() {
    signpic.src = URL.createObjectURL(inputFiles.files[0]);
  }
</script>

<script>
  let signm = document.getElementById("sign-m");
  let inputsign = document.getElementById("input-sign");


  inputsign.onchange = function() {
    signm.src = URL.createObjectURL(inputsign.files[0]);
  }
</script>
