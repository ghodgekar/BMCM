                ...
                <div class="hero">
                  <div class="card card1">
                    ...
                    <div class="text-center image">
                      ...
                      <input type="file" name="upload_file[]" accept="image/jpeg,image/png,image/jpg" id="input-file"
                        style="display:none">
                    </div>
                    <br>
                  </div>
              ...
              <div class="col-xl-9">
                <div class="card-body p-md-5 text-black">
                    ...
                    <div class="col-md-4 mb-4">
                      <div class="form-outline">
                        <input type="text" id="form3Example1m" class="form-control form-control-lg" name="f_name"
                          placeholder="First name/नाव " style="font-size:15px" />
                    ...
                    <div class="col-md-4 mb-4">
                      <div class="form-outline">
                        <input type="text" id="form3Example1n" class="form-control form-control-lg" name="m_name"
                          placeholder="Middel name/वडिलांचे नाव " style="font-size:15px" />
                        <!-- <label class="form-label" for="form3Example1n">Middel name/वडिलांचे नाव</label> -->
                      </div>
                    </div>
                    <div class="col-md-4 mb-4">
                      <div class="form-outline">
                        <input type="text" id="form3Example11" class="form-control form-control-lg" name="l_name"
                          placeholder="Last name/आडनाव " style="font-size:15px" />
                  ...
                  <div class="row">
                    <div class="col-md-4 mb-4">
                      <div class="form-outline">
                        <input type="text" id="form3Example1m15" class="form-control form-control-lg" name="mobile_no"
                          placeholder="Mobile No/दूरध्वनी क्रमांक" style="font-size:15px" />
                        <!-- <label class="form-label" for="form3Example1m1">Mobile No/दूरध्वनी क्रमांक:-</label> -->
                      </div>
                    </div>
                    <div class="col-md-4 mb-4">
                      <div class="form-outline">
                        <input type="text" id="form3Example1n16" class="form-control form-control-lg" name="emp_id"
                          placeholder="Employee ID/कममचारी संकेतांक" style="font-size:15px" />
                        <!-- <label class="form-label" for="form3Example1n1">Employee ID/कममचारी संकेतांक</label> -->
                      </div>
                    </div>
                    <div class="col-md-4 mb-4">
                      <div class="form-outline">
                        <input type="text" id="form3Example1n7" class="form-control form-control-lg" name="dob"
                          placeholder="DOB/जन्मतारीख " style="font-size:15px" />
                    ...
                    <div class="col-md-6 mb-4">
                      <div class="form-outline mb-4">
                        <input type="text" id="form3Example97" class="form-control form-control-lg" name="email"
                          placeholder="Email ID/ई-मेल आयडी" style="font-size:15px" />
                        <!-- <label class="form-label" for="form3Example97">Email ID/ई-मेल आयडी</label> -->
                      </div>
                    </div>
                    <div class="col-md-6 mb-4">
                      <div class="form-outline">
                        <input type="text" id="form3Example1n18" class="form-control form-control-lg" name="blood_grup"
                          placeholder="Blood Group/रक्तगट " style="font-size:15px" />
                        <!-- <label class="form-label" for="form3Example1n1">Blood Group/रक्तगट</label> -->
                      </div>
                    </div>
                  </div>
                  <div class="form-outline mb-4">
                    <input type="text" id="form3Example979" class="form-control form-control-lg"
                  ...
                  <div class="form-outline mb-4">
                    <input type="text" id="form3Example970" class="form-control form-control-lg" name="current_address"
                      placeholder="Current Address/सध्याचे वास्तव्याचा पत्ता" style="font-size:15px" />
                  ...
                  <div class="row">
                    <div class="col-md-6 mb-4">
                      <div class="form-outline">
                        <input type="text" id="form3Example1m12" class="form-control form-control-lg" name="password"
                          placeholder=" Create Password" style="font-size:15px" />
                        <!-- <label class="form-label" for="form3Example1m1">Create Password</label> -->
                      </div>
                    </div>
                    <div class="col-md-6 mb-4">
                      <div class="form-outline">
                        <input type="text" id="form3Example1n14" class="form-control form-control-lg"
                          name="password_confirm" placeholder="Confirm Password" style="font-size:15px" />
                    ...
                    <div class="col-md-4 mb-4">
                      <div class="form-outline">
                        <input type="text" id="form3Example1m" class="form-control form-control-lg" name="position"
                          placeholder="Position/पद/हुद्दा " style="font-size:15px" />
                    ...
                    <div class="col-md-4 mb-4">
                      <div class="form-outline">
                        <input type="text" id="form3Example1n" class="form-control form-control-lg" name="department"
                          placeholder="Department/खाते " style="font-size:15px" />
                        <!-- <label class="form-label" for="form3Example1n">Department/खाते</label> -->
                      </div>
                    </div>
                    ...
                    <div class="col-md-4 mb-4">
                      <div class="form-outline">
                        <input type="text" id="form3Example1n" class="form-control form-control-lg" name="division"
                          placeholder="Division/विभाग " style="font-size:15px" />
                  ...
                  <div class="row">
                    <div class="col-md-6 mb-4">
                      <div class="form-outline mb-4">
                        <input type="text" id="form3Example1n" class="form-control form-control-lg" name="ward"
                          placeholder="Ward/ " style="font-size:15px" />
                        <!-- <label class="form-label" for="form3Example97">Email ID/ई-मेल आयडी</label> -->
                      </div>
                    </div>
                    <div class="col-md-6 mb-4">
                    ...
                    <div class="row">
                      <div class="col-md-12 mb-4">
                        <div class="form-outline">
                          <input type="text" id="form3Example1m11" class="form-control form-control-lg"
                            name="recommender_name" placeholder="Name of Recommender/शिफारस करणाऱ्याचे नाव"
                      ...
                      <div class="col-md-6 mb-4">
                        <div class="form-outline">
                          <input type="text" id="form3Example1n21" class="form-control form-control-lg"
                      ...
                      <div class="col-md-6 mb-4">
                        <div class="form-outline">
                          <input type="text" id="form3Example1n31" class="form-control form-control-lg"
                    ...
                    <div class="form-outline mb-4">
                      <input type="text" id="form3Example597" class="form-control form-control-lg"
                        placeholder="Cheque/Netbanking/GPay/PhonePay/PayTM" name="fees_type" style="font-size:15px" />
                      <label class="form-label" for="form3Example97"> <span style="font-size:12px">(Mode Of
                          Payment)</span>
                      </label>
                    ...
                    <div class="row">
                      <div class="col-md-6 mb-4">
                        <div class="form-outline">
                          <input type="text" id="form3Example51m1" class="form-control form-control-lg"
                            placeholder="Transaction ID" name="fees_transaction_id" style="font-size:15px" />
                          <!-- <label class="form-label" for="form3Example1m1">Transaction ID</label> -->
                        </div>
                      </div>
                      <div class="col-md-6 mb-4">
                        <div class="form-outline">
                          <input type="text" id="form3Example51n1" class="form-control form-control-lg"
                            placeholder="शुल्क भरल्याची दिनांक" name="fees_date" style="font-size:15px" />
                      ...
                      <div class="col-md-12 mb-4">
                        <div class="">
                          <label class="radio-inline" style="margin-right: 30px;">
                            <input type="radio" name="fees_amt" value="1001">  आजीवन सभासद शुल्क-रुपये १००१/
                          </label> 
                          <label class="radio-inline" style="margin-right: 30px;">
                            <input type="radio" name="fees_amt" value="201">  वार्षिक सभासद शुल्क-रुपये २०१/
                          </label>
                          <label class="radio-inline" style="margin-right: 30px;">
                            <input type="radio" name="fees_amt" value="51">  प्रवेश फी - रुपये ५१/
                          </label>
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="d-flex justify-content-end pt-3">
                      ...
                      <button type="submit" class="btn btn-warning btn-lg ms-2 submitBtn"
                        style="background-color: #f44336;">Submit form</button>
                    </div>
                  </div>
                </div>
              </div>
