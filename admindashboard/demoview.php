...
.col-form-label-sm {
 ...
 <div class=" p-2 bd-highlight content">
    ...
    <p><b>पत्ता:-</b> तळमजला, एफ, सीताराम बिल्डिंग , अण्णासाहेब दौंडकर मार्ग, क्रॉफर्ड मार्केट, फोर्ट, मुंबई-००१</p>
...
<p><span style="border:2px solid red;color:red;padding:5px;font-weight:600">आजीवन/ वार्षिक सभासद नोंदणी अर्ज </span></p></div>
...
महोदय,
      <p style="text-indent: 2em;">मी बृहन्मुंबई महानगरपालिकेत  कार्यरत /सेवानिवृत्त कर्मचारी आहे. मराठा मंडळ सामाजिक संस्थेचे उद्देश, कार्य आणि नियम यांची
...
<div class="container">
  <!--row2-->
 <div class="row mb-1">
    <label for="inputtext" class="col-sm-3 col-form-label-sm">1.संपूर्ण नाव :-</label>
    <div class="col-sm-9">
...
<!--row end-->
    ...
    <!--row2-->
    <div class="row mb-1">
    <label for="inputtext" class="col-sm-3 col-form-label-sm">२.मराठा/कुणबी/कुणबी मराठा:-</label>
    <div class="col-sm-9">
      <input type="text" class="form-control" id="input">
    </div>
  </div>
...
<div class="row mb-1">
    <label for="inputEmail3" class="col-sm-2 col-form-label-sm">४.दूरध्वनी क्रमांक :-</label>
    <div class="col-sm-3">
...
<!--row end-->
 <!--row2-->
 <div class="row mb-1">
    <label for="inputEmail3" class="col-sm-2 col-form-label-sm">७.मूळ गावचा पत्ता :-</label>
    <div class="col-sm-10">
      <input type="text" class="form-control" id="inputEmail3">
    </div>
  </div>
<!--row end-->
 <!--row2-->
 <div class="row mb-1">
    <label for="inputEmail3" class="col-sm-2 col-form-label-sm">८.सध्याचे वास्तव्याचा पत्ता :-</label>
    <div class="col-sm-10">
      <input type="text" class="form-control" id="inputEmail3">
    </div>
  </div>
...
<div class="d-flex justify-content-end">
 <div class="col-sm-4"><input type="text" class="form-control" id="inputEmail3"></div></div>
 <div class="d-flex justify-content-end"> 
 <p><b style="padding: 15px;
    padding-right: 53px;
">अर्जदाराची सही </b></p></div>
...
<div class="row mb-1">
    <label for="inputEmail3" class="col-sm-3 col-form-label-sm">शिफारस करणाऱ्याचे नाव- श्री./श्रीम.</label>
    <div class="col-sm-4">
      <input type="text" class="form-control" id="inputEmail3">
    </div>
