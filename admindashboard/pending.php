...
<div class="container">
    <div class="text-right" style="text-align: right;">
        <a href='excel_report.php?s=1' class="btn btn-success" target='_blank'>Open Excel</a>
    </div>
    <br>
    ...
    ?>
            <tr class="text-center">
                ...
                <td>
                    ...
                    <button type="button" class="btn btn-success submitBtn approveBtn"
                        data-id="<?php echo $row['id']; ?>" data-status="2" id="approveBtn">Approve</button>
                    <button type="button" class="btn btn-danger submitBtn rejectBtn" data-id="<?php echo $row['id']; ?>"
