    ...
    <tbody>
      ...
      while ($row = mysqli_fetch_assoc($result)) {
        ...
        <tr class="text-center">
          ...
          <td>
            <button type="button" class="btn btn-primary submitBtn" data-id="<?php echo $row['id']; ?>" id="viewBtn"
              data-bs-toggle="modal" data-bs-target="#exampleModal">view</button>
            <button type="button" class="btn btn-success submitBtn" data-id="<?php echo $row['id']; ?>" data-status="2"
